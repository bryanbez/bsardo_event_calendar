...
class SettingsApi {
    ...
    public function withSubpages(string $sub_page_title = null) {
        ...
        $first_subpage = [
            [ 
                ...
                'menu_title' => ($sub_page_title) ? $sub_page_title : $admin_page['menu_title'],
        ...
        $this->admin_subpages = $first_subpage;
